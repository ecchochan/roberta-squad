...
import transformers
@register_model('roberta_mnli_hf')
class RobertaMNLIModelHF(transformers.BertForSequenceClassification, BaseFairseqModel):

    def __init__(self, *args, **kwargs):
        transformers.BertForSequenceClassification.__init__(self, *args, **kwargs)
...
@register_criterion('mnli_hf')
class MNLICriterionHF(FairseqCriterion):
